...
class Subject(BaseModel):
    ...
    subject_type_id = Column(Integer, ForeignKey("subject_types.id", ondelete="RESTRICT"), nullable=True, index=True)
    ...
    subject_type = relationship("SubjectType", back_populates="subjects", lazy="selectin")
    curriculum_mappings = relationship("CurriculumSubject", back_populates="subject", lazy="selectin")
