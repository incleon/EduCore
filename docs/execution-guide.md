...
[database-setup.md](database-setup.md). That guide must be followed whenever the database
state changes.
...
[database-setup.md](database-setup.md#initialize-a-new-database).
...
1. [Create the database and application user](database-setup.md#create-the-database-and-application-user)
2. [Configure `backend/.env`](database-setup.md#configure-backendenv)
3. [Initialize a new database](database-setup.md#initialize-a-new-database)

For an existing installation, use
[Upgrade an existing database](database-setup.md#upgrade-an-existing-database)
...
[database-setup.md](database-setup.md#system-data-and-demonstration-data).
...
[database-setup.md](database-setup.md#backup-and-restore).
...
[database-setup.md](database-setup.md#cannot-connect-to-mysql).
